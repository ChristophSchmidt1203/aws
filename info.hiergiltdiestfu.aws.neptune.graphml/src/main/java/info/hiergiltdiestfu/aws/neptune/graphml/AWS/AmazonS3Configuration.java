...
/**
 * This Class is the Configuration of the AWS-Connection.
 * It manages the connection options to AWS S3.
 * @author LUNOACK
 *
 */
@Configuration
public class AmazonS3Configuration {
	...
	/**
	 * Gives the property for the KeyID for AWS.
	 * @return
	 */
	@Bean(name="awskeyid")
	...
	/**
	 * Gives the property for the SecretKey for AWS.
	 * @return
	 */
